...
export const GeoLocation: NextPage = () => {
    ...
    return (
        ...
        <div className="flex flex-col gap-2 xl:gap-8 px-4 w-full max-w-xs xl:max-w-md">
            <HeaderLocation
        ...
        <div className="flex flex-col gap-6 xl:flex-row flex-wrap justify-center">
            ...
            filteredSaloes.map((salao, index) => (
                <div key={index} className="flex flex-col justify-center bg-color-principal w-full max-w-xs xl:max-w-sm h-auto px-4 py-4 gap-2 rounded-xl">
                <img
                    src={salao.foto}
