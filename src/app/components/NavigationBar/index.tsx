...
export function NavigationBar(){
    ...
    return (
        ...
        // <footer className="fixed bottom-0 left-0 z-50 w-[768px] mx-auto my-0">
        //     <nav className="h-12 p-1 flex items-center justify-evenly text-zinc-400">
        //         <Link className={pathname == "/home" ? "flex items-center justify-evenly text-zinc-400" : "flex items-center justify-evenly text-btn-primary-color"} href="/home">
